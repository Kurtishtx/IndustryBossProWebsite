...
const COMPARE = [
  { feature: 'Monthly Price', us: '$199 flat', them: '$400â€“$800+' },
  { feature: 'Users Included', us: 'Unlimited', them: 'Limited by plan' },
  { feature: 'Industries Covered', us: '9 specific trades', them: 'Generic / 1â€“2 trades' },
  ...
  { feature: 'Chemical Compliance', us: 'Yes â€” EPA compliant', them: 'No' },
  { feature: 'Mobile App', us: 'Yes', them: 'Yes (some)' },
  { feature: 'Free Trial', us: '14 days, no card', them: 'Varies' },
  { feature: 'Setup Fee', us: 'None', them: 'Often $500â€“$2,000' },
    ...
    <div style={{ background: S.navy1, minHeight: '100vh', color: S.text, fontFamily: "'Inter','Segoe UI',Arial,sans-serif" }}>
      ...
      <div style={{ maxWidth: 620, margin: '0 auto', padding: '80px 24px 0' }}>
        <div style={{ background: S.navy4, border: `3px solid ${S.elec}`, borderRadius: 20, padding: '52px 48px', position: 'relative', boxShadow: `0 0 60px ${e('.2')}, 0 0 0 8px ${e('.06')}` }}>
          ...
          <div style={{ color: S.muted, fontSize: 14, marginTop: 6, marginBottom: 32 }}>per month Â· cancel anytime Â· no contracts</div>
          <ul style={{ listStyle: 'none', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px 24px', marginBottom: 36 }}>
            {INCLUDED.map(li => (
              <li key={li} style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13, color: S.text }}>
                <span style={{ color: S.elec, fontWeight: 700, fontSize: 14 }}>âœ“</span>{li}
              </li>
            ))}
          </ul>
      ...
      <div style={{ maxWidth: 700, margin: '0 auto 80px', padding: '0 24px' }}>
        ...
        {[
          ...
          { q: 'How many users can I add?', a: 'Unlimited. Add your whole crew â€” techs, office staff, managers â€” at no extra cost.' },
          ...
          { q: 'What industries are supported?', a: 'Snow removal, pool service, landscaping, irrigation, lawn care, pest control, mosquito control, fence, and lawn mowing â€” all on one platform.' },
        ].map(item => (
