...
const INCLUDED = [
  ...
  'Chemical Compliance Logging', 'Estimates & Invoices', 'Stripe Payments',
  'Two-Way SMS', 'Mobile App for Techs', '500 SMS/month included',
  '+$15 per 500 extra SMS', 'Free Onboarding Call',
];
...
const COMPARE = [
  ...
  { feature: 'Pending Job Board', us: 'Built-in', them: 'Not available' },
