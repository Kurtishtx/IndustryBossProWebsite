    ...
    <div style={{ background: S.navy1, minHeight: '100vh', color: S.text, fontFamily: "'Inter','Segoe UI',Arial,sans-serif", padding: '80px 24px' }}>
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        {[
          ...
          { title: '4. Subscription & Billing', body: 'Subscriptions are billed monthly at the rate of the plan you select — $49, $89 or $199 per month. You may cancel at any time. Cancellation takes effect at the end of the current billing period. No refunds are issued for partial months.' },
