    ...
    <div style={{ background: S.navy1, minHeight: '100vh', color: S.text, fontFamily: "'Inter','Segoe UI',Arial,sans-serif", padding: '80px 24px' }}>
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        {[
          ...
          { title: '2. Description of Service', body: 'IndustryBossPro provides field service management software for outdoor service businesses including snow removal, landscaping, irrigation, lawn care, pest control, mosquito control, pool service, fence installation, and lawn mowing operations.' },
