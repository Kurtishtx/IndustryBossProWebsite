      ...
      <div style={{ paddingTop: 66 }}>
        ...
        <div style={{ background: `linear-gradient(160deg, #0a0a0a, #111111)`, padding: '90px 24px 70px', textAlign: 'center', borderBottom: `1px solid ${S.border}` }}>
          ...
          <p style={{ color: S.muted, fontSize: 15, maxWidth: 620, margin: '0 auto 36px' }}>
            Same scheduling, routing, invoicing, mobile app, and the same three plans from $59/month. Pick the one built for what you do — or run everything from IndustryBossPro.
          </p>
        ...
        <div style={{ textAlign: 'center', padding: '20px 24px 100px' }}>
          ...
          <p style={{ color: S.muted, fontSize: 17, marginBottom: 32 }}>Three plans from $59/month. No credit card to start. 14-day free trial.</p>
