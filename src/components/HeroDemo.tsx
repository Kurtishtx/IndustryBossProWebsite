...
const DEMOS: Record<Key, Demo> = {
  business: {
    ...
    url: 'https://my.industrybosspro.com/demo.html?v=5',
    label: '🖥️ Desktop version', kind: 'desktop',
    cap: 'The full software you run everything from — the Waiting List, map-based route building, scheduling, billing, and more.',
  },
  client: {
    url: 'https://boss-pro-client-mobile.vercel.app/customer-home.html?demo=1&v=5',
    label: '👤 Client app', kind: 'phone',
    cap: 'What your customers see — visits, invoices, pay a bill, live tracking, and alerts their way.',
  },
  crew: {
    url: 'https://boss-pro-mobile.vercel.app/?demo=1&v=5',
