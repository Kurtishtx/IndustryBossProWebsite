...
const S = {
  navy1: '#0a0a0a', navy2: '#0a0a0a', navy3: '#111111', navy4: '#1a1a1a', navy5: '#1a1a1a',
  elec: '#ff6a00', elecDark: '#e63000', muted: 'rgba(245,245,245,0.55)',
...
export default function HubPageTemplate({ page }: { page: HubPageData }) {
  ...
  return (
    <div style={{ background: S.navy1, minHeight: '100vh', color: S.text, fontFamily: "'Inter','Segoe UI',Arial,sans-serif" }}>
      ...
      <main>
      {/* HERO */}
      <section style={{ paddingTop: 120, paddingBottom: 80, background: `linear-gradient(180deg, #0a0a0a 0%, #111111 100%)` }}>
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 24px', textAlign: 'center' }}>
          <div style={{ display: 'inline-block', background: 'rgba(255,255,255,0.12)', border: `1px solid #e63000`, borderRadius: 20, padding: '4px 14px', fontSize: 13, color: S.elec, fontWeight: 600, marginBottom: 20 }}>
            {page.industry}
          </div>
      ...
      <section style={{ padding: '80px 24px', background: S.navy1 }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'center' }}>
          <div>
            <div style={{ display: 'inline-block', background: 'rgba(255,255,255,0.12)', border: `1px solid #e63000`, borderRadius: 20, padding: '4px 14px', fontSize: 12, color: S.elec, fontWeight: 700, letterSpacing: 1, textTransform: 'uppercase', marginBottom: 16 }}>
              The Killer Feature
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: 220 }}>
              ...
              <div style={{ padding: '16px' }}>
                ...
                {['Client A', 'Client B', 'Client C'].map((c, i) => (
                  <div key={i} style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid #e63000', borderRadius: 6, padding: '8px 10px', marginBottom: 8, fontSize: 12 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 32 }}>
            {HOW_STEPS.map(s => (
              <div key={s.n} style={{ textAlign: 'center' }}>
                <div style={{ width: 52, height: 52, borderRadius: '50%', background: 'rgba(255,255,255,0.12)', border: `2px solid ${S.elec}`, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px', fontSize: 20, fontWeight: 800, color: S.elec }}>
                  {s.n}
                </div>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24 }}>
            {[
              ...
              { icon: '💬', title: 'Automated SMS Suite', desc: '10+ SMS alert types run automatically — appointment reminders, on-my-way notifications, job completion confirmations, estimate follow-ups, and payment reminders. Automated alerts and the two-way inbox are on Pro and up. Texts included: 500 a month on Start, 1,000 on Pro, 2,000 on Crew, counted sent and received. 500 extra texts are $15. Auto-routing: 50 / 100 / 1,000 a month, 250 extra for $5; Smart Lasso is unlimited.' },
      ...
      {/* CTA BAND */}
      <section style={{ padding: '80px 24px', background: `linear-gradient(135deg, #111111 0%, #0a0a0a 100%)`, borderTop: `1px solid ${S.border}`, textAlign: 'center' }}>
