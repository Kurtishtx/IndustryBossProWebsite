...
const S = {
  ...
  border: 'rgba(255,106,0,0.18)', text: '#f5f5f5',
};
    ...
    <div style={{ background: S.navy1, minHeight: '100vh', color: S.text, fontFamily: "'Inter','Segoe UI',Arial,sans-serif" }}>
      ...
      <section style={{ paddingTop: 120, paddingBottom: 80, background: `linear-gradient(180deg, #0a0a0a 0%, #111111 100%)` }}>
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 24px', textAlign: 'center' }}>
          <div style={{ display: 'inline-block', background: 'rgba(255,106,0,0.12)', border: `1px solid rgba(255,106,0,0.3)`, borderRadius: 20, padding: '4px 14px', fontSize: 13, color: S.elec, fontWeight: 600, marginBottom: 20 }}>
            {page.industry}
          </div>
      ...
      <section style={{ padding: '80px 24px', background: S.navy1 }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'center' }}>
          <div>
            <div style={{ display: 'inline-block', background: 'rgba(255,106,0,0.12)', border: `1px solid rgba(255,106,0,0.3)`, borderRadius: 20, padding: '4px 14px', fontSize: 12, color: S.elec, fontWeight: 700, letterSpacing: 1, textTransform: 'uppercase', marginBottom: 16 }}>
              The Killer Feature
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: 220 }}>
              ...
              <div style={{ padding: '16px' }}>
                ...
                {['Client A', 'Client B', 'Client C'].map((c, i) => (
                  <div key={i} style={{ background: 'rgba(255,106,0,0.08)', border: '1px solid rgba(255,106,0,0.2)', borderRadius: 6, padding: '8px 10px', marginBottom: 8, fontSize: 12 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 32 }}>
            {HOW_STEPS.map(s => (
              <div key={s.n} style={{ textAlign: 'center' }}>
                <div style={{ width: 52, height: 52, borderRadius: '50%', background: 'rgba(255,106,0,0.12)', border: `2px solid ${S.elec}`, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px', fontSize: 20, fontWeight: 800, color: S.elec }}>
                  {s.n}
                </div>
      ...
      <section style={{ padding: '60px 24px', background: S.navy3, borderTop: `1px solid ${S.border}` }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, justifyContent: 'center' }}>
            {INDUSTRIES.map(ind => (
              <span key={ind} style={{ background: ind === page.industry ? 'rgba(255,106,0,0.15)' : 'rgba(255,255,255,0.04)', border: `1px solid ${ind === page.industry ? 'rgba(255,106,0,0.4)' : S.border}`, borderRadius: 20, padding: '6px 14px', fontSize: 13, color: ind === page.industry ? S.elec : S.muted, fontWeight: ind === page.industry ? 700 : 400 }}>
                {ind}
              </span>
            ))}
          </div>
