        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24 }}>
            {[
              ...
              { icon: '💬', title: 'Automated SMS Suite', desc: '10+ SMS alert types run automatically — appointment reminders, on-my-way notifications, job completion confirmations, estimate follow-ups, and payment reminders. Automated alerts and the two-way inbox are on Pro and up. Texts included: 500 a month on Start, 1,000 on Pro, 2,000 on Crew, counted sent and received. 500 extra texts are $15.' },
