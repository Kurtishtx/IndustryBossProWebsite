      ...
      <section id="pricing" style={{ padding: '80px 24px', background: S.navy1 }}>
        <div style={{ maxWidth: 480, margin: '0 auto' }}>
          ...
          <div style={{ background: S.navy4, border: `2px solid ${S.elec}`, borderRadius: 20, padding: '40px 36px', boxShadow: `0 0 60px rgba(0,184,255,0.15)`, textAlign: 'center' }}>
            ...
            {['Unlimited Users', '14-Day Free Trial', 'All 9 Industries', 'Pending Job Board', 'Calendar & Dispatch Views', 'Live Crew Tracking', '100 Auto Routes Included', '+$10 per 300 more', 'Chemical Compliance Logging', 'Mobile App for Crews', 'Card Payments (Stripe)', '500 SMS/month Included', '+$10 per 250 more SMS', 'No Setup Fees', 'No Contracts'].map(item => (
